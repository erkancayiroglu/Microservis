using Dapper;
using Mikroservis.Discount.Context;
using Mikroservis.Discount.Dtos;

namespace Mikroservis.Discount.Services
{
    public class DiscountService:IDiscountService
    {
        ...
        public async Task CreateDiscountCouponAsync(CreateDiscountCouponDto createCouponDto)
        {
            ...
            {
                await connection.ExecuteAsync(query, parameters);// Dapper
            }
        }
